	    <section class="panel">
		    <header class="panel-heading">
				 Store in Mall Details
			</header>
			<?php print_r($before);?>
			<div class="panel-body">
			  <form class="form-horizontal tasi-form" method="post" action="<?php echo site_url('site/editstoreinmallsubmit');?>" enctype= "multipart/form-data">
				...
				<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
						   <?php 
								echo form_dropdown('mall',$mall,set_value('mall',$before->mall),'id="select3" class="form-control populate placeholder select2-offscreen"');
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
						   <?php 
								echo form_dropdown('floor',$floor,set_value('floor',$before->floor),'id="select4" class="form-control populate placeholder select2-offscreen"');
...
<!--					<input type="test" id="normal-field" class="form-control" name="workinghours" value="<?php echo set_value('workinghours');?>">-->
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
						   <?php 
								echo form_dropdown('shopclosedon',$shopclosedon,set_value('shopclosedon',$before->shopclosedon),'id="select10" class="form-control populate placeholder select2-offscreen"');
...
<!--
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-4">
					<input type="text" id="normal-field" class="form-control" name="facebookpage" value="<?php echo set_value('facebookpage',$before->facebookpage);?>">
				  </div>
				</div>
				<div class="form-group">
				  <label class="col-sm-2 control-label" for="normal-field">Twitter Page</label>
				  <div class="col-sm-4">
					<input type="text" id="normal-field" class="form-control" name="twitterpage" value="<?php echo set_value('twitterpage',$before->twitterpage);?>">
				  </div>
				</div>
-->
				...
				<div class=" form-group">
				  ...
				  <a href="<?php echo site_url('site/viewstoreinmall'); ?>" class="btn btn-secondary">Cancel</a>
				</div>
				</div>
			  </form>
